...
\begin{figure}[h!]
    ...
    facing down represent \texttt{or} gates, triangles facing up \texttt{and}
    gates, diamonds \texttt{counter} measures, and boxes \texttt{basic} events.
    Basic events contain multiple attributes for quantitative analysis.}
\end{figure}
...
represent \texttt{and} gates, triangles facing down to represent \texttt{or}
gates.
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[height=0.8\paperheight]{dns}
    \caption{}
\end{figure}
