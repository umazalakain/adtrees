...
\url{https://github.com/umazalakain/adtrees}. A ready to install Haskell package
is published at \url{https://hackage.haskell.org/package/adtrees-0.1.0.0}. It
can be installed with \texttt{cabal} as follows:
