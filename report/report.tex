...
On the other hand, the difficulty for the attacker depends on the actor of a
node:
...
Once a semantics is defined, an attack defense can be inductively evaluated:
...
The API for the translation into Graphviz is the following:
