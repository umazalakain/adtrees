...
7, and 10]{secdns} and \cite{dns-threat-analysis}. Some are omitted, as they are
only pertinent to enterprise environments, not to the service a top-level domain
resolver would offer. 
