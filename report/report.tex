...
To demonstrate how a CA might use this tool to guide an asses an OES, I perform
a case analysis on the provision of the top-level domain \texttt{.uk} by Nominet
\footnote{\url{https://nominet.uk}}, where Ofcom is the competent authority as
designated regulator for digital infrastructure.

Concretely, the library allows for the evaluation of the following points of the
...
\begin{description}
    ...
    \item [D1a]
        \begin{itemize}
            \item Your incident response plan is based on a clear understanding
                of the security risks to the networks and information systems
...
events in a fault tree \textit{must} be unique and independent. Every directed
