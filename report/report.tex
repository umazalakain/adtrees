...
hosting of DNS services, and ignores any attacks that could take place during
interaction with other machines.

The main source for both threats and the protective meassures is \cite{secdns}.
Clarifications and further information can be found in \cite{weaknesses-dns},
\cite{rfc3833} and \cite{dns-bind-sec}.
